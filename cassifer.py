...
if up == "2":
        ...
        print ('code for Channel ≠>' + '%s%s yttk-17926 %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "3":
        print ('code group ≠>' + '%s%s http://0x282f466168617368692e28342e322e352e385d29 %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "4":
        ...
        print ('code for account ≠>' + '%s%s http://0x7966747431356b %s' % (fg('red'), bg('yellow'), attr('reset')))
